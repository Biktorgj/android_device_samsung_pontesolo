...
MSM8226_DTS_FILES = $(wildcard $(TOP)/$(TARGET_KERNEL_SOURCE)/arch/arm/boot/dts/msm8226-tizen_b3-*.dts)
...
## Attempt to build dzImage
# cat device/samsung/pontesolo/dzHeader > $(PRODUCT_OUT)/dzImage; \
# cat $(PRODUCT_OUT)/kernel >> $(PRODUCT_OUT)/dzImage; \
# cat $(PRODUCT_OUT)/dt.img >> $(PRODUCT_OUT)/dzImage; \
# @echo -e ${CL_CYN}"dzImage done!"${CL_RST}
